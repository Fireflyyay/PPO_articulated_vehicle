...
# runtime falls back to the existing fast-prune mask without online full rollout.
SOFT_ACTION_MASK_ENABLE = True
SOFT_MASK_GAMMA = 1.5
SOFT_MASK_EPS = 0.01
...
SOFT_MASK_MAX_GUARD_CANDIDATES = 3
SOFT_MASK_EMERGENCY_PRIMITIVE_ID = None
SOFT_MASK_PROFILE = True
