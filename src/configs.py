...
FPS = 100
TOLERANT_TIME = 700 # Increased from 200 to 1000 to match finer control frequency (0.2s * 1000 = 200s total duration)
USE_LIDAR = True
...
PPO_DYNAMIC_PREFIX_NARROW_MIN_LIDAR = 0.5
PPO_DYNAMIC_PREFIX_CRITICAL_MIN_LIDAR = 0.3
...
# =============================================================
# Training scene curriculum warmup
# =============================================================
TRAIN_SCENE_WARMUP_LEVEL = 'Warmup'
TRAIN_SCENE_WARMUP_EPISODES = 5000
